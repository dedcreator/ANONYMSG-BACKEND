...
if EMAIL_PORT == 587:
    ...
    EMAIL_USE_TLS = os.getenv('EMAIL_USE_TLS', 'False').lower() in ('true', '1', 't', 'yes')

EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', '')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', '')

if EMAIL_HOST_USER:
    DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', f'AnonQ <{EMAIL_HOST_USER}>')
else:
    DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'AnonQ <noreply@anonq.me>')

FRONTEND_URL = os.getenv('FRONTEND_URL', 'https://anonyqna.vercel.app' if not DEBUG else 'http://localhost:3000')
